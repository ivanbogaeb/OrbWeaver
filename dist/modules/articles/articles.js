...
class Articles {
    constructor() {
        ...
        const request = (url, component, location, language, images, extractURLs, verbose, amount) => {
            let requestURL = url.concat(encodeURIComponent(component), parameters(location, language));
            return (0, scrapper_1.scrapper)(requestURL, images, extractURLs, verbose, amount);
        };
